...
#
# This module manages mailserver package installation on suse based systems
#
# Parameters:
#
...
class mailserver::package::suse (
  ...
  $debian_packages = [ "postfix", "postfix-mysql", "amvisd", "clamav", "spamassassin", "dovecot-common", "dovecot-core", "dovecot-imapd", "dovecot-managesieved", "dovecot-mysql", "dovecot-pop3d", "dovecot-sieve", "dovecot-antispam" ]
