...
class mailserver (
  ...
  $mailserver_packages_list               = $mailserver::params::mailserver_packages_list,
  $mailserver_packages_ensure             = $mailserver::params::mailserver_packages_ensure,
  $mailserver_vhosts                      = {},
 ...
 class { 'mailserver::package':
    packages_list   => $mailserver_packages_list,
    packages_ensure => $mailserver_packages_ensure,
