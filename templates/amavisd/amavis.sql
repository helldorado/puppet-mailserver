...
CREATE TABLE msgs (
  ...
  content     binary(1),                   -- content type: V/B/U/S/Y/M/H/O/T/C
...
(PARTITION p0 VALUES IN (0,1,2,3,4,5) ENGINE = InnoDB,
 PARTITION p1 VALUES IN (6,7,8,9,10,11) ENGINE = InnoDB,
 PARTITION p2 VALUES IN (12,13,14,15,16,17) ENGINE = InnoDB,
 PARTITION p3 VALUES IN (18,19,20,21,22,23) ENGINE = InnoDB,
 PARTITION p4 VALUES IN (24,25,26,27,28,29) ENGINE = InnoDB,
 PARTITION p5 VALUES IN (30,31,32,33,34,35) ENGINE = InnoDB,
 PARTITION p6 VALUES IN (36,37,38,39,40,41) ENGINE = InnoDB,
 PARTITION p7 VALUES IN (42,43,44,45,46,47) ENGINE = InnoDB,
 PARTITION p8 VALUES IN (48,49,50,51,52,53) ENGINE = InnoDB);
